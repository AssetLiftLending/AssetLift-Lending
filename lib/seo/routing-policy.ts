...
export const PRIORITY_CITY_PATHS = new Set([
  ...
  '/lending/new-jersey/freehold',
  '/lending/new-jersey/middletown',
  '/lending/new-jersey/red-bank',
  '/lending/new-jersey/long-branch',
  '/lending/new-jersey/edison',
  '/lending/new-jersey/woodbridge',
  '/lending/new-jersey/new-brunswick',
  '/lending/new-jersey/old-bridge',
