...
export const CITIES: CityData[] = [
  ...
  // New Jersey - Qualified investor markets
  {
    ...
    population: "305,000",
    medianHomePrice: "$450,000",
    overview: "Newark is one of New Jersey's most active investor markets, with strong demand for 2-4 unit properties, mixed-use assets, value-add rentals, and urban infill opportunities. Experienced borrowers use hard money, bridge, and DSCR financing in Newark when they can support the file with tight neighborhood comps, realistic taxes, clear tenant status, and a credible sale or refinance exit.",
    investmentHighlight: "Newark gives investors access to dense rental demand, transit access, major employment anchors, and value-add housing stock. The best loan files are specific about the neighborhood, unit mix, rent support, rehab scope, taxes, and municipal timeline.",
    topNeighborhoods: ["Ironbound", "Forest Hill", "University Heights", "North Newark", "Weequahic", "Vailsburg", "Clinton Hill", "South Ward"],
    faqs: [
      { question: "What types of Newark investor loans are strongest?", answer: "Newark files are strongest when the borrower can document a clear fix-and-flip, bridge-to-rental, or DSCR exit. Two- to four-unit properties, mixed-use assets, and value-add rentals can all work when the file includes local comps, rent support, reserves, and a realistic scope of work." },
      { question: "What do lenders watch on Newark deals?", answer: "Lenders pay close attention to tenant status, taxes, title, municipal items, property condition, and block-level comparable sales. A broad Newark or Essex County valuation story is usually weaker than tight neighborhood support." },
      { question: "Can I use DSCR financing in Newark?", answer: "Yes. DSCR financing can work for stabilized Newark rentals when rents support the full payment after taxes, insurance, and any other required costs. Transitional properties may need bridge or rehab financing before moving into DSCR debt." },
    ],
  },
  {
    ...
    population: "292,000",
    medianHomePrice: "$720,000",
    overview: "Jersey City is a high-demand Hudson County market where investors pursue condo projects, small multifamily assets, mixed-use properties, and rental holds near transit. Because basis can be high and submarkets behave differently, lenders expect experienced borrowers to present precise comps, accurate taxes, insurance, HOA details where applicable, and a clear payoff strategy.",
    investmentHighlight: "Jersey City's rental depth, transit access, and buyer demand support both DSCR and resale strategies, but the strongest opportunities require tight underwriting around neighborhood, property type, unit mix, and carrying costs.",
    topNeighborhoods: ["Journal Square", "The Heights", "Bergen-Lafayette", "Greenville", "McGinley Square", "West Side", "Downtown", "Communipaw"],
    faqs: [
      { question: "Is Jersey City a good market for DSCR loans?", answer: "Jersey City can be strong for DSCR loans when the rent supports the payment after taxes, insurance, and HOA or condo costs. Borrowers should include leases, rent comps, and property-specific expense assumptions." },
      { question: "What makes Jersey City hard money files complicated?", answer: "Complexity often comes from high basis, condo or HOA rules, tax assumptions, tenant status, and submarket differences. Downtown, Journal Square, The Heights, and Greenville should not be underwritten as the same market." },
      { question: "Can AssetLift fund Jersey City fix-and-flip or bridge deals?", answer: "Yes. AssetLift can review Jersey City fix-and-flip, bridge, construction, and DSCR scenarios for qualified investment property borrowers with a clear project and exit." },
    ],
  },
  {
    cityName: "Paterson",
  ...
  },
  {
    ...
    population: "660,000",
    medianHomePrice: "$510,000",
    overview: "Ocean County includes shore, suburban, and rental markets where investors pursue fix-and-flip, bridge, short-term rental, long-term rental, and DSCR strategies. Files in Toms River, Brick, Lakewood, Jackson, Point Pleasant, and Seaside Heights need clear insurance, flood, rent, and exit assumptions.",
    investmentHighlight: "Ocean County can provide both resale and rental opportunities, but shore exposure and insurance can change the numbers quickly. Strong files document the exact municipality, property use, rent support, and payoff plan.",
    topNeighborhoods: ["Toms River", "Brick", "Lakewood", "Jackson", "Point Pleasant", "Seaside Heights", "Bayville", "Manchester"],
    faqs: [
      { question: "Can Ocean County shore properties get investor loans?", answer: "Yes, qualifying shore properties can be reviewed, but borrowers should document insurance, flood exposure, seasonal demand, property condition, and exit timing." },
      { question: "What loan types work in Ocean County?", answer: "Fix-and-flip, bridge, construction, and DSCR rental loans can all work when the property and exit are supported by local data." },
      { question: "What should DSCR borrowers include?", answer: "DSCR borrowers should include leases or rent comps, tax bills, insurance quotes, HOA details if applicable, reserves, and entity documents." },
    ],
  },
  {
    cityName: "Trenton",
  ...
  },
  {
    ...
    overview: "Nassau County is a high-demand Long Island market where experienced investors pursue suburban flips, bridge loans, rental refinances, and selective small multifamily opportunities. Lenders expect town-specific comps, disciplined scope, realistic taxes, insurance, reserves, and a clear sale or DSCR refinance path.",
    investmentHighlight: "Nassau County can support strong resale exits, but higher basis and taxes make margin discipline critical. Strong files avoid broad Long Island assumptions and document the exact town and buyer pool.",
    topNeighborhoods: ["Hempstead", "Freeport", "Elmont", "Mineola", "Glen Cove", "Long Beach", "Valley Stream", "Westbury"],
    faqs: [
      { question: "Can I get hard money for a Nassau County flip?", answer: "Yes. Nassau County flips can qualify when the borrower supports ARV with town-specific comps, has a realistic scope, and shows enough reserves." },
      { question: "Do DSCR loans work in Nassau County?", answer: "They can, but higher purchase prices and property taxes make rent coverage important. Borrowers should document leases or rent comps, taxes, insurance, and reserves." },
      { question: "What do lenders watch in Nassau County?", answer: "Lenders watch basis, ARV support, tax load, insurance, renovation scope, and whether the exit still works if the project takes longer than planned." },
    ],
  },
  {
  ...
  },
  {
    ...
    population: "210,000",
    medianHomePrice: "$650,000",
    overview: "Yonkers is one of Westchester's most active investor markets, with opportunities across multifamily, mixed-use, bridge loans, fix-and-flip, and DSCR rental financing. Strong files document rent roll, legal unit count, taxes, insurance, condition, reserves, and whether the exit is sale or refinance.",
    investmentHighlight: "Yonkers benefits from proximity to New York City and a large rental base, but lenders expect local comps, clear tenant status, and realistic operating costs.",
    topNeighborhoods: ["Getty Square", "Park Hill", "Ludlow", "Northwest Yonkers", "Dunwoodie", "Lincoln Park", "Crestwood", "Waterfront"],
    faqs: [
      { question: "Can Yonkers multifamily properties get private financing?", answer: "Yes. Multifamily and mixed-use scenarios can qualify when unit mix, rents, tenant status, taxes, insurance, and reserves are documented." },
      { question: "Can Yonkers rentals qualify for DSCR loans?", answer: "Yes, stabilized Yonkers rentals can qualify when documented rents support the full payment and the borrower has sufficient reserves." },
      { question: "What makes a Yonkers flip file stronger?", answer: "A strong file includes neighborhood comps, a line-item scope, contractor plan, realistic hold costs, reserves, and a clear resale timeline." },
    ],
  },
  {
    cityName: "Albany",
